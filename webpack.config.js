...
module.exports = {
  ...
  output: {
    path: path.join(__dirname, 'spice', 'static', 'build'),
    publicPath: `${publicHost}/engine/static/build/`,
  ...
  plugins: [
    ...
    new ManifestRevisionPlugin(path.join(__dirname, 'spice', 'webpack', 'manifest.json'), {
      rootAssetPath,
      ignorePaths: ['/js', '/css'],
